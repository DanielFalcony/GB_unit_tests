...
//        assertThat(Calculator.calculation(100, 50, '/')).isEqualTo(2);
        ...
        // Решение ДЗ №1
        assertThat(Calculator.calculatingDiscount(800, 10)).isEqualTo(720);
        System.out.println(Calculator.calculatingDiscount(800, 10));

        // HW1.1: Придумайте и опишите (можно в псевдокоде) функцию извлечения корня и
        // необходимые проверки для него используя граничные случаи
//         assertThatThrownBy(() ->
//                 seminars.first.Calculator.Calculator.squareRootExtraction(0, 1, -1).isInstanceOf(SomeStateException.class);

        // HW1.2: Как будет выглядеть проверка для случая деления на ноль? (с использованием AssertJ)
        // assertThatThrownBy(() ->
//                seminars.first.Calculator.Calculator.calculation(5, 0, '/').isInstanceOf(ArithmeticException.class);
